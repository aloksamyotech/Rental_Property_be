...
const router = Router();
import { createProperty,editProperty,getProperty,deleteProperty,vacantPropertyOnNotice} from "../controllers/property.controller.js";
...
router.get("/propertyOnNotice", asyncHandler(vacantPropertyOnNotice));
